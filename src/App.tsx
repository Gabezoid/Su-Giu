...
import { Search, ShoppingCart, Mail, ArrowRight } from "lucide-react";
...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Feature Banner */}
      <section className="py-24 px-8 md:px-24 bg-surface relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
          <div className="space-y-8">
            <h2 className="font-headline font-black text-5xl md:text-7xl uppercase leading-tight tracking-tighter">
              ...
              <span className="text-primary-container">Nessuno dei due limiti.</span>
            </h2>
            ...
            <a href="#" className="inline-flex items-center gap-2 font-headline uppercase tracking-widest text-lg border-b-4 border-primary-container pb-1 hover:text-primary-container transition-all">
      ...
      <footer className="bg-surface-container-high text-on-surface font-label text-xs uppercase tracking-widest mt-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 px-12 py-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="#" className="opacity-70 hover:opacity-100 hover:text-primary-container transition-all">Collezione</a>
            <a href="#" className="opacity-70 hover:opacity-100 hover:text-primary-container transition-all">Il Pantagonna</a>
